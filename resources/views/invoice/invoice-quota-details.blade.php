...
<div class='container'>
   ...
   <div class='row'>
       ...
       <div class="col-lg-4">
           <form class="pull-right" action="/sircular-dev/public/invoice/invoiceQuota/{{$invoiceID}}" method="POST">
           ...
           <table class='table'>
               ...
               <tbody>
                   ...
                   <tr>
                       <td><?php echo $i; $i++ ?></td>
                       <td>
                           <a href="/sircular-dev/public/circulation/distribution-realization/{{$details->delivery->distRealizationDet->distributionRealization->id}}/details/{{$details->delivery->distRealizationDet->id}}/delivery/{{$details->delivery->id}}">
           ...
           <table class='table'>
               <thead>
                   ...
                   <tr>
                       ...
                       <td class='monetary-fmt'>{{ $totalDelivery }}</td>
                       <td class='monetary-fmt'>{{ $totalDeliveryDiscount }}</td>
